...
void ConversationWidget::on_sendButton_clicked()
{
    ...
    QString msg;
    QString userName = "[" + LocalLocationInfomation::info().getLocalUserName() + "]";
    msg =  userName + " [100] " + " A " + ui->textEdit->toPlainText();
    UdpSender::socket().sendData("A " + talkTo + " " + msg + " \n");

    ui->textBrowser->append(QTime::currentTime().toString("hh:mm:ss") + " To "
